 ...
 */
        const messages = [
            { role: "system", content: "kamu adalah AzbryMD, Seorang Asisten pribadi yang di buat oleh FebryWesker yang siap membantu kapan pun!" },
            { role: "assistant", content: `Saya AzbryMD, asisten pribadi yang siap membantu kamu kapan pun! Apa yang bisa saya bantu hari ini?` },
